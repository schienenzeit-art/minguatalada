...
class ClaimStatus:
    ...
    ROLE_TRANSITIONS: ClassVar[Dict[str, Dict[str, List[str]]]] = {
        ...
        "Admin": {
            IN_PRUEFUNG: [ANSPRUCHSBERECHTIGT, HAERTEFALL, ABGELEHNT, ABGELAUFEN, ARCHIVIERT, WIDERSPRUCH],
            ANSPRUCHSBERECHTIGT: [IN_PRUEFUNG, HAERTEFALL, ABGELEHNT, ABGELAUFEN, ARCHIVIERT, WIDERSPRUCH],
            HAERTEFALL: [IN_PRUEFUNG, ANSPRUCHSBERECHTIGT, ABGELEHNT, ABGELAUFEN, ARCHIVIERT, WIDERSPRUCH],
            ABGELEHNT: [IN_PRUEFUNG, ANSPRUCHSBERECHTIGT, HAERTEFALL, ABGELAUFEN, ARCHIVIERT, WIDERSPRUCH],
