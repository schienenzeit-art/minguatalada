...
export const startsWithPerTermSearch = (subject, pattern) => {
    const result = {
        match: false,
        ranges: [],
    };
...
export const startsWithSearch = (subject, pattern) => {
    const result = {
        match: false,
        ranges: [],
    };
...
export const containsSearch = (subject, pattern) => {
    const result = {
        match: false,
        ranges: [],
    };
...
export const fuzzySearch = (subject, pattern) => {
    const result = {
        match: false,
        ranges: [],
    };
...
export const highlightRanges = (text, ranges) => {
    const res = [];
