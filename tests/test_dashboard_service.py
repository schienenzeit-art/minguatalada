...
class DashboardServiceTest(unittest.TestCase):
    ...
    def test_get_kpi_items_returns_clickable_metrics(self):
        ...
        self.assertEqual(kpis[0]["title"], "Offene Aufgaben")
        self.assertEqual(kpis[0]["page"], "tasks")
        self.assertEqual(kpis[1]["title"], "Offene Ansprüche")
        self.assertEqual(kpis[2]["title"], "Laufende Karten")
        self.assertEqual(kpis[3]["title"], "Genehmigte Fälle")
        self.assertEqual(kpis[4]["title"], "Abgelehnte Fälle")
